<template>
  <div id="login">
    ...
    <div id="form">
      <form @submit.prevent="doRegs">
        <label for="email">E-mail</label>
        <input type="text" id="email" v-model="email" placeholder="Input your email" autocomplete="off">
...
import axios from 'axios';
  ...
  export default {
    ...
    methods: {
      doRegs() {
        axios.post('https://makan-master.herokuapp.com/auth/users/', {
        email: this.email,
