...
import axios from 'axios';
  ...
  export default {
    ...
    methods: {
      doLogin() {
        axios.post('https://makan-master.herokuapp.com/auth/jwt/create', {
      ...
      .then(response => {
        ...
        return axios.get(`https://makan-master.herokuapp.com/api/recommendation`,
                {
                  headers: {
                      'Authorization':
      ...
      .then(response => {
          ...
          localStorage.setItem('contentID', response.data.content_id);
